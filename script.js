...
/* ABOUT PLAY NAVIGATION BAR MICROINTERACTION*/
// When the user scrolls down 80px from the top of the document, resize the navbar's padding and the logo's font size
window.onscroll = function() {scrollFunction()};

function scrollFunction() {
  if (document.body.scrollTop > 300 || document.documentElement.scrollTop > 300) {
    document.getElementById("material-section-nav-id").style.padding = "30px 10px";
    document.getElementById("grid-aboutplayindex-id").style.height = "180px";
  } else {
    document.getElementById("material-section-nav-id").style.padding = "80px 10px";
    document.getElementById("grid-aboutplayindex-id").style.height = "275px";
  }
}
